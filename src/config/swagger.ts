    ...
    schemas: {
      ...
      ScheduleConfig: {
        ...
        properties: {
          ...
          startDate: { type: "string", format: "date", description: "Tournament start date in YYYY-MM-DD format" },
          endDate: { type: "string", format: "date", description: "Tournament end date in YYYY-MM-DD format" },
