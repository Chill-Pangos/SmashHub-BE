    ...
    schemas: {
      ...
      ScheduleConfig: {
        ...
        properties: {
          ...
          startLunchBreak: { type: "string", format: "date-time", nullable: true, description: "Lunch break start date and time (optional)" },
          endLunchBreak: { type: "string", format: "date-time", nullable: true, description: "Lunch break end date and time (optional)" },
