...
const envSchema = Joi.object({
  ...
  DB_SSL_CA_PATH: Joi.string().allow(""),
  DB_SSL_CA_BASE64: Joi.string().allow(""),
  ...
  .or("DB_SSL_CA_PATH", "DB_SSL_CA_BASE64")
  .unknown(true);
...
const config = {
  ...
  mysql: {
    ...
    caPath: envVars.DB_SSL_CA_PATH,
    caBase64: envVars.DB_SSL_CA_BASE64,
  },
  email: {
    smtp: {
